...
az group create --name RG-AM-EastUS-POC-10M-CEP-ACS-ENGINE --location EastUS

az group deployment create --name "acs-engine-1" --resource-group RG-AM-EastUS-POC-10M-CEP-ACS-ENGINE --template-file "./_output/elc-am-eastus-cep-k8s/azuredeploy.json" --parameters "./_output/elc-am-eastus-cep-k8s/azuredeploy.parameters.json"
```
