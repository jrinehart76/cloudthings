...
$keyvaultRG = "rg-region1-QA-DLG-OtherPAAS"
write-host 'b'
#set contributor access policies for all vaults
foreach($k in $allKeyvaults){
Set-AzKeyVaultAccessPolicy -VaultName $k -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-CloudOps')[0].Id -PermissionsToSecrets get,list,set,delete,recover,backup,restore
Set-AzKeyVaultAccessPolicy -VaultName $k -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-CloudManagedServices')[0].Id -PermissionsToSecrets get,list,set,delete,recover,backup,restore
...
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_All')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_Fin')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_DTC')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_HR')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_SC')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_CsMkt')[0].Id -PermissionsToSecrets get,list

Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-Fnd" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_All')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-Fnd" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_Fin')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-Fnd" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_DTC')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-Fnd" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_HR')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-Fnd" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_SC')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-Fnd" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_CsMkt')[0].Id -PermissionsToSecrets get,list

Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-Fin" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_Fin')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-DTC" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_DTC')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-Mkt" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_CsMkt')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-SC" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_SC')[0].Id -PermissionsToSecrets get,list
Set-AzKeyVaultAccessPolicy -VaultName "AKV-AM-EUS-QA-DLG-HR" -ResourceGroupName $keyvaultRG -ObjectId (Get-AzADGroup -SearchString 'U-Customer-EDLGlobalQA_HR')[0].Id -PermissionsToSecrets get,list
