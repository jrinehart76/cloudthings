...
```
az group deployment  create --template-file aks.json -g rg-region1-POC-MSP-CEP-AKS --parameters azureServicePrincipalAppId=<SPappId> azureServicePrincipalAppKey=<SPKey> nodeSSHPublicKey=<sshKey>  serviceCidr=15.15.3.0/24 dnsServiceIP=15.15.3.5
```
