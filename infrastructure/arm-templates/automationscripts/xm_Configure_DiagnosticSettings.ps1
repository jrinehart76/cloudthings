...
$searchQuery = 'Resources | where location=="' + $location + '" | where type !contains "microsoft.compute" and type !contains "microsoft.operationsmanagement" and type !contains "microsoft.insights" and type !contains "workspaces" and type !contains "routetables" | project name, id'
