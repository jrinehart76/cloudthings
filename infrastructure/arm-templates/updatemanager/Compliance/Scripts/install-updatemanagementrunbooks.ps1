...
New-AzStorageAccount -Name "10mplatformautoscripts" -ResourceGroupName $saResourceGroup -Location $rg.location -SkuName "Standard_LRS" -ErrorAction SilentlyContinue
$keys = Get-AzStorageAccountKey -Name "10mplatformautoscripts" -ResourceGroupName $saResourceGroup
$ctx = New-AzStorageContext -StorageAccountName "10mplatformautoscripts" -StorageAccountKey $keys.Value[0]
