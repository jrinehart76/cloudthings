<#
.SYNOPSIS
    Deploys Linux VM monitoring alerts for Azure Monitor.

.DESCRIPTION
    This script deploys comprehensive Azure Monitor alert rules for Linux virtual
    ...
    These alerts enable proactive monitoring of Linux VMs to:
...
.NOTES
    ...
    - ARM template files must be in the same directory:
      * alert.critical.linuxperf.json
      * alert.critical.linuxdisk.json
      * alert.warning.linuxperf.json
      * alert.warning.linuxdisk.json
    ...
    Impact: Provides comprehensive monitoring for Linux VMs to prevent outages,
...
Write-Output "=========================================="
Write-Output "Deploy Linux VM Monitoring Alerts"
Write-Output "=========================================="
...
Write-Output "Deploying Linux critical performance alerts..."
Try {
...
Write-Output "Deploying Linux critical disk space alerts..."
Try {
    New-AzResourceGroupDeployment `
...
Write-Output "Deploying Linux warning performance alerts..."
Try {
    New-AzResourceGroupDeployment `
...
Write-Output "Deploying Linux warning disk space alerts..."
Try {
    New-AzResourceGroupDeployment `
